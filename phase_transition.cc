...
StokesProblem<dim>::StokesProblem(unsigned int    velocity_degree,
  ...
  , lambda_psi(InlineFunctions::compute_lambda_from_h(density_l, surface_tension_psi_ac, eps, 0.148918)) /*which density should be used? for water ice  h= 0.159505, g=0.1594389483*/ 
  , mobility_phi(1e-3)
  , mobility_psi(1.)
  , latent_heat(1)
  , melting_t(273.)
...
{
  const std::string prefix = "tmp683/";
